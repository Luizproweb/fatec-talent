...
class ModeloTrabalho extends TRecord
{
    const TABLENAME  = 'modelo_trabalho';
    const PRIMARYKEY = 'id';
    ...
    public function getVagas()
    {
        ...
        $criteria->add(new TFilter('modelo_trabalho_id', '=', $this->id));
    ...
    public function get_vaga_pessoa_to_string()
    {
        ...
        $values = Vaga::where('modelo_trabalho_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->id}');
    ...
    public function get_vaga_regime_trabalho_to_string()
    {
        ...
        $values = Vaga::where('modelo_trabalho_id', '=', $this->id)->getIndexedArray('regime_trabalho_id','{regime_trabalho->id}');
        return implode(', ', $values);
    }
    ...
    public function get_vaga_modelo_trabalho_to_string()
    {
        ...
        $values = Vaga::where('modelo_trabalho_id', '=', $this->id)->getIndexedArray('modelo_trabalho_id','{modelo_trabalho->id}');
        return implode(', ', $values);
    }
    ...
    public function get_vaga_curso_to_string()
    {
        ...
        $values = Vaga::where('modelo_trabalho_id', '=', $this->id)->getIndexedArray('curso_id','{curso->id}');
        return implode(', ', $values);
    }
