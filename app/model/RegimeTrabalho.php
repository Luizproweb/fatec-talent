...
class RegimeTrabalho extends TRecord
{
    ...
    public function getVagas()
    {
        ...
        $criteria->add(new TFilter('regime_trabalho_id', '=', $this->id));
    ...
    public function get_vaga_pessoa_to_string()
    {
        ...
        $values = Vaga::where('regime_trabalho_id', '=', $this->id)->getIndexedArray('pessoa_id','{pessoa->id}');
    ...
    public function get_vaga_regime_trabalho_to_string()
    {
        ...
        $values = Vaga::where('regime_trabalho_id', '=', $this->id)->getIndexedArray('regime_trabalho_id','{regime_trabalho->id}');
        return implode(', ', $values);
    }
    ...
    public function get_vaga_modelo_trabalho_to_string()
    {
        ...
        $values = Vaga::where('regime_trabalho_id', '=', $this->id)->getIndexedArray('modelo_trabalho_id','{modelo_trabalho->id}');
        return implode(', ', $values);
    }
    ...
    public function get_vaga_curso_to_string()
    {
        ...
        $values = Vaga::where('regime_trabalho_id', '=', $this->id)->getIndexedArray('curso_id','{curso->id}');
        return implode(', ', $values);
    }
