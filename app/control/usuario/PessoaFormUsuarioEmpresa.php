...
class PessoaFormUsuarioEmpresa extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $cadastro_pessoa->addFields([new TLabel("Telefone :", null, '14px', null, '100%'),$fone],[new TLabel("Celular :", null, '14px', null, '100%'),$celular]);
        ...
        $action_onEditDetailEndereco = new TDataGridAction(array('PessoaFormUsuarioEmpresa', 'onEditDetailEndereco'));
        ...
        $action_onDeleteDetailEndereco = new TDataGridAction(array('PessoaFormUsuarioEmpresa', 'onDeleteDetailEndereco'));
        ...
        $row12 = $this->form->addFields([$cadastro_pessoa]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['PessoaListUsuarioEmpresa', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('PessoaFormUsuarioEmpresa', 'onEdit', ['key'=> $object->id]);    
