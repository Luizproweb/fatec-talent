...
class SystemUserForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $unit_id       = new TDBCombo('system_unit_id','u316696823_fatec_talent','SystemUnit','id','name');
        $groups        = new TDBCheckGroup('groups','u316696823_fatec_talent','SystemGroup','id','name');
        $frontpage_id  = new TDBUniqueSearch('frontpage_id', 'u316696823_fatec_talent', 'SystemProgram', 'id', 'name', 'name');
        $units         = new TDBCheckGroup('units','u316696823_fatec_talent','SystemUnit','id','name');
